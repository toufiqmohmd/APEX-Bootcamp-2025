...
REFUNDED - there has been an issue with the order and the money has been returned to the customer.';
  ...
  CREATE UNIQUE INDEX "CLOTHING_LOOKUP_PK" ON "CLOTHING_LOOKUP" ("CLOTHING_ID") 
  ;

  CREATE UNIQUE INDEX "COLOR_LOOKUP_PK" ON "COLOR_LOOKUP" ("COLOR_ID") 
  ;

  CREATE UNIQUE INDEX "CUSTOMERS_EMAIL_U" ON "CUSTOMERS" ("EMAIL_ADDRESS") 
  ;
  ...
  CREATE UNIQUE INDEX "DEPARTMENTS_ID_PK" ON "DEPARTMENTS" ("ID") 
  ;

  CREATE UNIQUE INDEX "DEPARTMENT_LOOKUP_PK" ON "DEPARTMENT_LOOKUP" ("DEPARTMENT_ID") 
  ;

  CREATE INDEX "EMPLOYEES_I1" ON "EMPLOYEES" ("DEPARTMENT_ID") 
  ;

  CREATE UNIQUE INDEX "EMPLOYEES_ID_PK" ON "EMPLOYEES" ("ID") 
  ;
