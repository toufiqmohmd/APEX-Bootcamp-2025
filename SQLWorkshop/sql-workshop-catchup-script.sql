CREATE TABLE "PRODUCTS" (
    "PRODUCT_ID"         NUMBER
        GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 50 NOCACHE
...
CREATE TABLE "STORES" (
    "STORE_ID"          NUMBER
        GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 25 NOCACHE
        NOORDER NOCYCLE NOKEEP NOSCALE
    NOT NULL ENABLE,
...
CREATE TABLE "CUSTOMERS" (
    "CUSTOMER_ID"   NUMBER
        GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 400 NOCACHE
        NOORDER NOCYCLE NOKEEP NOSCALE
    NOT NULL ENABLE,
...
CREATE TABLE "ORDERS" (
    "ORDER_ID"       NUMBER
        GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2000 NOCACHE
        NOORDER NOCYCLE NOKEEP NOSCALE
    NOT NULL ENABLE,
...
CREATE TABLE "ORDER_ITEMS" (
    ...
    CONSTRAINT "ORDER_ITEMS_PK" PRIMARY KEY ( "ORDER_ID",
                                              "LINE_ITEM_ID" )
        USING INDEX ENABLE,
    CONSTRAINT "ORDER_ITEMS_PRODUCT_U" UNIQUE ( "PRODUCT_ID",
                                                "ORDER_ID" )
        USING INDEX ENABLE
);
...
CREATE OR REPLACE EDITIONABLE TRIGGER "EMPLOYEES_BIU" BEFORE
...
ALTER TABLE "ORDERS"
    ADD CONSTRAINT "ORDERS_STORE_ID_FK"
...
COMMENT ON COLUMN "ORDERS"."ORDER_DATETIME" IS
...
COMMENT ON COLUMN "PRODUCTS"."UNIT_PRICE" IS
    'The monetary value of one item of this producty';

COMMENT ON COLUMN "PRODUCTS"."PRODUCT_DETAILS" IS
    'Further details of the product stored in JSON format';

COMMENT ON COLUMN "PRODUCTS"."PRODUCT_IMAGE" IS
    'A picture of the product';

COMMENT ON COLUMN "PRODUCTS"."IMAGE_MIME_TYPE" IS
    'The mime-type of the product image';

COMMENT ON COLUMN "PRODUCTS"."IMAGE_FILENAME" IS
    'The name of the file loaded in the image column';

COMMENT ON COLUMN "PRODUCTS"."IMAGE_CHARSET" IS
    'The character set used to encode the image';

COMMENT ON COLUMN "PRODUCTS"."IMAGE_LAST_UPDATED" IS
...
COMMENT ON COLUMN "STORES"."WEB_ADDRESS" IS
    'The URL of a virtual store';

COMMENT ON COLUMN "STORES"."PHYSICAL_ADDRESS" IS
...
COMMENT ON COLUMN "STORES"."LOGO" IS
    'An image used by this store';

COMMENT ON COLUMN "STORES"."LOGO_MIME_TYPE" IS
    'The mime-type of the store logo';

COMMENT ON COLUMN "STORES"."LOGO_FILENAME" IS
    'The name of the file loaded in the image column';

COMMENT ON COLUMN "STORES"."LOGO_CHARSET" IS
    'The character set used to encode the image';

COMMENT ON COLUMN "STORES"."LOGO_LAST_UPDATED" IS
    'The date the image was last changed';

COMMENT ON TABLE "STORES" IS
    'Physical and virtual locations where people can purchase products';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."ORDER_ID" IS
    'The primary key of the order';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."ORDER_DATETIME" IS
    'The date and time the order was placed';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."ORDER_STATUS" IS
    'The current state of this order';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."CUSTOMER_ID" IS
    'The primary key of the customer';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."EMAIL_ADDRESS" IS
    'The email address the person uses to access the account';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."FULL_NAME" IS
    'What this customer is called';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."ORDER_TOTAL" IS
    'The total amount the customer paid for the order';

COMMENT ON COLUMN "CUSTOMER_ORDER_PRODUCTS"."ITEMS" IS
    'A comma-separated list naming the products in this order';

COMMENT ON TABLE "CUSTOMER_ORDER_PRODUCTS" IS
...
COMMENT ON COLUMN "PRODUCT_ORDERS"."ORDER_STATUS" IS
    'The current state of these order';

COMMENT ON COLUMN "PRODUCT_ORDERS"."TOTAL_SALES" IS
    'The total value of orders placed';

COMMENT ON COLUMN "PRODUCT_ORDERS"."ORDER_COUNT" IS
    'The total number of orders placed';

COMMENT ON TABLE "PRODUCT_ORDERS" IS
    'A summary of the state of the orders placed for each product';

COMMENT ON COLUMN "PRODUCT_REVIEWS"."PRODUCT_NAME" IS
    'What this product is called';

COMMENT ON COLUMN "PRODUCT_REVIEWS"."RATING" IS
    'The review score the customer has placed. Range is 1-10';

COMMENT ON COLUMN "PRODUCT_REVIEWS"."AVG_RATING" IS
    'The mean of the review scores for this product';

COMMENT ON COLUMN "PRODUCT_REVIEWS"."REVIEW" IS
    'The text of the review';

COMMENT ON TABLE "PRODUCT_REVIEWS" IS
    'A relational view of the reviews stored in the JSON for each product';

COMMENT ON COLUMN "STORE_ORDERS"."TOTAL" IS
    'Indicates what type of total is displayed, including Store, Status, or Grand Totals';

COMMENT ON COLUMN "STORE_ORDERS"."STORE_NAME" IS
    'What the store is called';

COMMENT ON COLUMN "STORE_ORDERS"."ADDRESS" IS
    'The physical or virtual location of this store';

COMMENT ON COLUMN "STORE_ORDERS"."LATITUDE" IS
    'The north-south position of a physical store';

COMMENT ON COLUMN "STORE_ORDERS"."LONGITUDE" IS
    'The east-west position of a physical store';

COMMENT ON COLUMN "STORE_ORDERS"."ORDER_STATUS" IS
    'The current state of this order';

COMMENT ON COLUMN "STORE_ORDERS"."ORDER_COUNT" IS
    'The primary key of the order';

COMMENT ON COLUMN "STORE_ORDERS"."TOTAL_SALES" IS
    'The total value of orders placed';

COMMENT ON TABLE "STORE_ORDERS" IS
    'A summary of what was purchased at each location, including summaries each store, order status and overall total';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."STORE_NAME" IS
    'What the store is called';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."ADDRESS" IS
    'The physical or virtual location of this store';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."LATITUDE" IS
    'The north-south position of a physical store';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."LONGITUDE" IS
    'The east-west position of a physical store';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."ORDER_STATUS" IS
    'The current state of this order';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."ORDER_COUNT" IS
    'The primary key of the order';

COMMENT ON COLUMN "STORE_ORDERS_STATUS"."TOTAL_SALES" IS
    'The total value of orders placed';

COMMENT ON TABLE "STORE_ORDERS_STATUS" IS
    'A summary of what was purchased at each location for each order status';

CREATE UNIQUE INDEX "CLOTHING_LOOKUP_PK" ON
    "CLOTHING_LOOKUP" (
        "CLOTHING_ID"
    );

CREATE UNIQUE INDEX "COLOR_LOOKUP_PK" ON
    "COLOR_LOOKUP" (
        "COLOR_ID"
    );

CREATE UNIQUE INDEX "CUSTOMERS_EMAIL_U" ON
    "CUSTOMERS" (
        "EMAIL_ADDRESS"
    );
...
CREATE UNIQUE INDEX "CUSTOMERS_PK" ON
    "CUSTOMERS" (
        "CUSTOMER_ID"
    );

CREATE UNIQUE INDEX "DEPARTMENTS_ID_PK" ON
    "DEPARTMENTS" (
        "ID"
    );

CREATE UNIQUE INDEX "DEPARTMENT_LOOKUP_PK" ON
    "DEPARTMENT_LOOKUP" (
        "DEPARTMENT_ID"
    );
...
CREATE UNIQUE INDEX "EMPLOYEES_ID_PK" ON
    "EMPLOYEES" (
        "ID"
    );
...
CREATE UNIQUE INDEX "ORDER_ITEMS_PK" ON
    "ORDER_ITEMS" (
        "ORDER_ID",
        "LINE_ITEM_ID"
    );

CREATE UNIQUE INDEX "ORDER_ITEMS_PRODUCT_U" ON
    "ORDER_ITEMS" (
        "PRODUCT_ID",
        "ORDER_ID"
    );

CREATE UNIQUE INDEX "PRODUCTS_PK" ON
    "PRODUCTS" (
        "PRODUCT_ID"
    );

CREATE UNIQUE INDEX "STORES_PK" ON
    "STORES" (
        "STORE_ID"
    );

CREATE UNIQUE INDEX "STORE_NAME_U" ON
    "STORES" (
        "STORE_NAME"
    );

CREATE UNIQUE INDEX "SYS_C00183778521" ON
    "PROJECTS" (
        "ID"
    );
...
CREATE UNIQUE INDEX "PRODUCTS_PK" ON
  ...
  CREATE UNIQUE INDEX "SYS_IL0428179335C00004$$" ON "PRODUCTS" (
  ;
  CREATE UNIQUE INDEX "SYS_IL0428179335C00005$$" ON "PRODUCTS" (
  ;
  ...
  CREATE UNIQUE INDEX "SYS_C00183778521" ON "PROJECTS" ("ID") 
  ;
  ...
  ;
  CREATE UNIQUE INDEX "SYS_IL0428179329C00007$$" ON "STORES" (;
    COMMENT
    ON
    COLUMN
    "STORES"."STORE_ID"
    ...
    AS
    PROCEDURE
    ADD_PRODUCT ( P_PRODUCT IN NUMBER, P_QUANTITY IN NUMBER )
  IS
  BEGIN
