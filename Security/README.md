The "Supporting Objects" folder contains 3 scripts for implementing "Custom Authentication" as part of this workshop. Upload all these 3 scripts under SQL Workshop > SQL Scripts".
